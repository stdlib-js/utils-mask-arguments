...
```javascript
import maskArguments from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-mask-arguments@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/utils-mask-arguments/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/utils-mask-arguments/actions/workflows/test.yml?query=branch:v0.2.2
